...
<html>
  ...
  <body>
    ...
    if (isset($_POST["nom"]) && isset($_POST["idasso"]) && isset($_POST["motdepasse"])) {
      $connection =0;
      ...
      $mdp = sha1($pass.$salt);
        ...
        $req = $db->prepare("INSERT INTO compte(nom, idasso, mdp, salage) VALUES(:nom, :idasso, :mdp, :salage)");
    ...
    <div id="hauteur">
      <form action="inscription.php" method="POST">
        <div id="formulaire">
          ...
          <input type="password" name="motdepasse" placeholder='********' id="champs" />
